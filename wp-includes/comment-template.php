...
function comment_form( $args = array(), $post_id = null ) {
	...
	$defaults = array(
		...
		'submit_button'        => '<a href="#" class="btn-primary btn-input"><input name="%1$s" type="submit" id="%2$s" class="%3$s" value="%4$s" /><span class="overlay-btn"></span></a>',
		'submit_field'         => '<div class="button-wrapper">%1$s %2$s</div>',
		'format'               => 'xhtml',
	);
