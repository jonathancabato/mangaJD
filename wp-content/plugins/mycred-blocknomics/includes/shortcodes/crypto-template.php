...
if(is_plugin_active( 'mycred/mycred.php' )){
    ...
    ?>
                    ...
                    foreach ( $amounts as $amount ) {
                        $i++;
                    echo '<li> <a class="madara_purchase_points" href="#" value="' . esc_attr( $amount ) . '" option="'.$i.'" ';
                    ...
                    echo '><div class="card card-body mb-2"><div class="coin-wrapper"><i class="fas fa-crown"></i><p>x' . $mycred->format_creds( $amount ) . '</p></div><p>$'.$madara_price.'</p></a></div></li>';
