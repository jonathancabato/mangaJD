...
add_shortcode('wp_manga_author_revenue', 'wp_manga_chapter_coin_shortcode_author_revenue');

function wp_manga_chapter_coin_shortcode_author_revenue( $atts, $content = '' ) {
        $author_id = 0;
