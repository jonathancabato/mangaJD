    ...
    <div class="modal fade" id="form-login" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <ul class="nav nav-tabs justify-content-center align-items-center mb-5">
                    <li class="nav-item" id="login-nav">
                        <a class="nav-link active" aria-current="page" href="#login">Login</a>
                    </li>

                    <li class="nav-item" id="sign-in-nav">
                        <a class="nav-link" href="#sign-up" tabindex="-1" >Register</a>
                    </li>
                </ul>

                    <div id="login" class="login">
                        <h3>
                            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" tabindex="-1"><?php echo esc_html__( '', WP_MANGA_TEXTDOMAIN ); ?></a>
                        </h3>
                        ...
                        <form name="loginform" id="loginform" method="post">
                            <p>
                                <label><?php echo esc_html__( 'USERNAME', WP_MANGA_TEXTDOMAIN ); ?>
                                    <br> <input type="text" name="log" class="input user_login" value="" size="20" placeholder="Within 20 Characters">
                                </label>
                            </p>
                            <p>
                                <label><?php echo esc_html__( 'PASSWORD', WP_MANGA_TEXTDOMAIN ); ?>
                                    <br> <input type="password" autocomplete="" name="pwd" class="input user_pass" value="" size="20"  placeholder="Within 20 Characters">
                                </label>
                            </p>
                            <p>
                    ...
                    <div id="sign-up" class="login" style="display:none">
                        <h3>
                            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" tabindex="-1"><?php echo esc_html__( '', WP_MANGA_TEXTDOMAIN ); ?></a>
                        </h3>
                        ...
                        <form name="registerform" id="registerform" novalidate="novalidate">
                            <p>
                                <label><?php echo esc_html__( 'USERNAME', WP_MANGA_TEXTDOMAIN ); ?>
                                    <br>
                                    <input type="text" name="user_sign-up" class="input user_login" value="" size="20"  placeholder="Within 20 Characters">
                                </label>
                            </p>
                            <p>
                                <label><?php echo esc_html__( 'EMAIL ADDRESS', WP_MANGA_TEXTDOMAIN ); ?>
                                    <br>
                                    <input type="email" name="email_sign-up" class="input user_email" value="" size="20"  placeholder="Within 20 Characters">
                                </label>
                            </p>
                            <p>
                                <label><?php echo esc_html__( 'PASSWORD', WP_MANGA_TEXTDOMAIN ); ?><br>
                                    <input type="password" name="pass_sign-up" autocomplete="" class="input user_pass" value="" size="25" placeholder="Within 20 Characters" >
                                </label>
                            </p>
                            <p>
                            ...
                            <p class="submit">
                                <input type="submit" name="wp-submit" class="button button-primary button-large wp-submit" value="<?php esc_html_e( 'CREATE ACCOUNT', WP_MANGA_TEXTDOMAIN ); ?>">
                            </p>
                        </form>
                        <!-- <p class="nav">
