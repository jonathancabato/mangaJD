			...
			if(is_singular('wp-manga')){
				...
				if($reading_chapter){
					...
					wp_localize_script( 'wp-manga', 'mangaNav', array(
						...
						'text'         => array(
							'backInfoPage' => esc_html__( 'Chapter List', WP_MANGA_TEXTDOMAIN ),
							'prev'         => esc_html__( 'Prev Chapter', WP_MANGA_TEXTDOMAIN ),
							'next'         => esc_html__( 'Next Chapter', WP_MANGA_TEXTDOMAIN ),
						)
					) );
				}
			}
