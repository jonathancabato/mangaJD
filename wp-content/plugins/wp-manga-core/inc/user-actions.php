		...
		function get_user_section( $size = 50, $echo = false ) {
			...
			if ( ! empty( $link ) ) {
				$user_menu .= '
					...
					<li class="icon-list points width-33"> 
						<a href="' . esc_url( $link ) . '"><i class="fas fa-star"></i><p>' . esc_html__( $balance . ' Points', WP_MANGA_TEXTDOMAIN ) . '</p></a>
					</li>
					<li class="icon-list mycred-buy"><a href="javascript:void(0)" data-toggle="modal" data-target="#myCredForm" class="btn .mycred-buy"><i class="fas fa-coins"></i>Buy</a></li>' .
				...
				// 	</li>
					...
					'<li class="icon-list bookmark  width-33">
