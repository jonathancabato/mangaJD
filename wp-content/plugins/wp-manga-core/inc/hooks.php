...
add_action('wp-manga_rating', 'wp_manga_single_manga_info_user_rate', 10, 1);
...
add_action('wp-manga_rank', 'wp_manga_single_manga_info_rank', 12, 1);
...
add_action('wp-manga_tagline', 'wp_manga_single_manga_info_afternativename', 14, 1);
...
add_action('wp-manga_author', 'wp_manga_single_manga_info_authors', 16, 1);
...
if(!function_exists('wp_manga_single_manga_info_genres')){
	function wp_manga_single_manga_info_genres( $manga_id ) {
		...
		$terms = wp_get_post_terms($manga_id, 'wp-manga-genre');
		global $wp_manga_template;
...
add_action('wp-manga_status', 'wp_manga_single_manga_info_status', 12, 1);
...
add_action('wp-manga_bookmark', 'wp_manga_single_manga_user_buttons', 12, 1);
...
if(!function_exists('wp_manga_single_manga_info_chapters')){
	function wp_manga_single_manga_info_chapters( $manga_id ) {
		?>
		<div id="manga-chapters-holder" class="manga-tabs" data-id="<?php echo esc_attr($manga_id);?>"><i class="fas fa-spinner fa-spin fa-3x"></i></div>
		<?php
		/**
