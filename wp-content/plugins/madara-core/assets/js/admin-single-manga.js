...
jQuery(document).ready(function ($) {
	...
	$(status).find('#manga_status_settings').attr('style' , 'display:block!important')
	$(release).find('#tagsdiv-wp-manga-release').attr('style' , 'display:block!important')
	$(author).find('#tagsdiv-wp-manga-author').attr('style' , 'display:block!important')
	$(artist).find('#tagsdiv-wp-manga-artist').attr('style' , 'display:block!important')
	$(genre).find('#wp-manga-genrediv').attr('style' , 'display:block!important')
	$(views).find('#manga_views').attr('style' , 'display:block!important')
	$(tags).find('#tagsdiv-wp-manga-tag').attr('style' , 'display:block!important')
