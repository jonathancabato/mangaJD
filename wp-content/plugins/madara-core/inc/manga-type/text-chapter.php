                ...
                <div class="select-pagination">
                    <div class="nav-links">
						...
						<?php if ( isset( $prev_chap ) && $prev_chap !== $cur_chap_link ): ?>
                            <div class="nav-previous <?php echo apply_filters('wp_manga_chapter_nagivation_button_class', '', $prev_chapter, $chapter['post_id'], $prev_chap);?>"><a href="<?php echo $prev_chap; ?>" class="btn prev_page" title="<?php echo $prev_chapter['chapter_name'];?>"><?php esc_html_e('Prev Chapter', WP_MANGA_TEXTDOMAIN ); ?></a>
                            </div>
                        <?php else : ?>
							<div class="nav-previous <?php echo apply_filters('wp_manga_chapter_nagivation_button_class', '', $prev_chapter, $chapter['post_id'], $prev_chap);?>"><span class="btn prev_page prev_page_disabled" title="<?php echo $prev_chapter['chapter_name'];?>"><?php esc_html_e('Prev Chapter', WP_MANGA_TEXTDOMAIN ); ?></span>
							</div>
						<?php endif ?>
						<div class="nav-next">
								<a href="<?php echo esc_url(get_permalink($chapter['post_id']) . ((isset($is_amp_required) && $is_amp_required) ? 'amp' : ''));?>" class="btn back" >
									<?php esc_html_e( 'Chapter List', WP_MANGA_TEXTDOMAIN ); ?>
								</a>
							</div>
                        <?php 
						
						if ( isset( $next_chap ) ): ?>
                            <div class="nav-next <?php echo apply_filters('wp_manga_chapter_nagivation_button_class', '', $next_chapter, $chapter['post_id'], $next_chap);?>"><a href="<?php echo $next_chap ?>" class="btn next_page" title="<?php echo $next_chapter['chapter_name'];?>"><?php esc_html_e('Next Chapter', WP_MANGA_TEXTDOMAIN ); ?></a></div>
                        <?php else: ?>
							<?php
							endif;
						?>
