            ...
            <div class="search-content">
                <form role="search" method="get" class="search-form">
                    <label> 
						...
						<button type="submit" class="search-submit" value="<?php esc_html_e( 'Search', 'madara' ); ?>"><i class="fa fa-search"></i></button>
                        <input type="search" class="search-field" placeholder="<?php esc_html_e( 'Search by Stories & Author', 'madara' ); ?>" value="<?php echo esc_attr( $s ); ?>" name="s">
                    </label>
                </form>
            </div>
        </div>
                                ...
                                <div class="tab-wrap">
                                    <div class="c-blog__heading style-2 font-heading">
                                        <h4>
											...
											<?php echo sprintf( _n(  'result (%s)', 'result (%s)', $wp_query->found_posts, 'madara' ), $wp_query->found_posts ); ?>
                                        </h4>
                                    </div>
                                </div>
                                <!-- Tab panes -->
